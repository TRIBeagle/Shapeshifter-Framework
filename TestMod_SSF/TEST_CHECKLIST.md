...
- [ ] 변신 규율: 섭리에 대한 모독 → **변신 금지** (기즈모 비활성, CanTransformBasic false), 강제 변신 시 기분 -10, 의견 -20, 기억 감정 -10 (5일)
- [ ] 변신 규율: 부자연스러운 힘 → 변신 시 기분 -5, 의견 -10, 기억 감정 -5 (3일)
- [ ] 변신 규율: 관심 없음 → 변신 시 감정 없음
- [ ] 변신 규율: 특별한 재능 → 변신 시 기분 +5, 의견 +10
- [ ] 변신 규율: 신이 내린 축복 → 변신 시 기분 +10, 의견 +20
