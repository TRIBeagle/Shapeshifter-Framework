...
namespace ShapeshifterFramework.Hediffs
{
    ...
    public partial class HediffComp_ShapeshiftCore : HediffComp
    {
        ...
        public void ApplyForm(ShapeshiftFormDef form, List<Thing> sources)
        {
            ...
            {
                try { Messages.Message("SSF_Message_CannotTransform".Translate(form.LabelCap), MessageTypeDefOf.RejectInput, false); } catch (System.Exception ex) { Log.Warning("[SSF] ApplyForm message display failed: " + ex.Message); }
