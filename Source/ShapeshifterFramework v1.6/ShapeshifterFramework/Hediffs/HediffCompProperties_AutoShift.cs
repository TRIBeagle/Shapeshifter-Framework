...
// 용도 : - 특정 hediff를 보유한 Pawn이 체력/정신상태/밤/전투 조건 충족 시 자동 변신.
...
namespace ShapeshifterFramework.Hediffs
{
    ...
    public class HediffCompProperties_AutoShift : HediffCompProperties
    {
        ...
        /// <summary>체력 비율이 이 값 미만이면 트리거. 0이면 미사용.</summary>
        ...
        /// <summary>밤(SunGlow &lt; 0.5)에 자동 트리거. false면 미사용.</summary>
        public bool triggerAtNight = false;
